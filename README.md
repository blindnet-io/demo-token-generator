...
<p align="center">
  ...
  &nbsp;•&nbsp;
  <a href="https://github.com/blindnet-io/quickstart-token-generator-javascript/issues">Submit an Issue</a>
  &nbsp;•&nbsp;
...
> **Warning**
>
> This library is for demonstration and testing purpose only, as it expose the application key.
> 
...
Use [npm][npm] or [yarn][yarn] to install the `@blindnet/token-generator` package:

```bash
npm install @blindnet/token-generator
```
...
[new-issue]: https://github.com/blindnet-io/quickstart-token-generator-javascript/issues/new/choose
[fork]: https://github.com/blindnet-io/quickstart-token-generator-javascript/fork
