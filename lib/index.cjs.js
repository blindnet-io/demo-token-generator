...
var Token = (function () {
    function Token(appId, key) {
        this.appId = appId;
        this.key = key;
    }
    Token.prototype.create = function (type) {
        var body = {
            app: this.appId,
            uid: this.userId,
...
var TokenBuilder = (function () {
    function TokenBuilder(appId, key) {
        var keyBytes = b64str2bin(key).slice(0, 32);
        this.token = new Token(appId, keyBytes);
        return this;
    }
    TokenBuilder.init = function (appId, key) {
        return new TokenBuilder(appId, key);
    };
    TokenBuilder.prototype.expiration = function (exp) {
        this.token.expiration = exp;
        return this;
    };
    TokenBuilder.prototype.user = function (usr) {
        this.token.userId = usr;
        return this.token.create('user');
    };
    TokenBuilder.prototype.app = function () {
        return this.token.create('app');
    };
    TokenBuilder.prototype.anon = function () {
